...
;;;;;;;;;; TAIL CALL EXAMPLE ;;;;;;;;;;
(slide 
 (para #:align 'center (large-text "Imagine This Machine"))
 (blank 50)
 (item (ht-append (tt "$RV") (t " - Return value register")))
 (left-align (t "       All functions put a result there"))
 (item (ht-append (tt "$ARG") (t " - Argument register")))
 (left-align (t "       Functions can only have one argument"))
 (left-align (t "       It must go in $ARG"))
 (item (ht-append (tt "$STACK") (t " - The call stack")))
 (left-align (t "       Holds return addresses only"))
 (left-align (t "       Has push and pop operations"))
)


(slide 
 (para #:align 'center (large-text "Simple Example"))
 (blank 50)
 (para #:align 'left
 (tt "def add3(n:Int) = n + 3"))
 (blank 25)
 (para #:align 'left (vl-append
 (tt "0  ADD3:")
 (tt "1    mov  $ARG $RV")
 (tt "2    add  3 $RV")
 (tt "3    goto $STACK.pop()")
...
(slide 
 (para #:align 'center (large-text "Another Example"))
 (blank 50)
 (para #:align 'left
 (tt "def seven = 7"))
 (blank 25)
...
(slide 
 (para #:align 'center (large-text "Example (Getting Interesting)"))
 (blank 50)
 (para #:align 'left
 (tt "def a() = { b(5); 42 }"))
 (blank 25)
...
(slide 
 (para #:align 'center (large-text "Example (Curious)"))
 (blank 50)
 (para #:align 'left
 (tt "def a = b(5)"))
 (blank 25)
  'alts
 (list
  (list (para #:align 'left (vl-append
          (tt "0  A:")
          (tt "1    mov  5 $ARG")
          (tt "2    $STACK.push(A:4)")
          (tt "3    goto B")
  ...
  (list (para #:align 'left (vl-append
          ...
          (tt "2    $STACK.push(A:4)")
          (tt "3    goto B")
          (ht-append (tt "4    mov  $RV $RV") (colorize (t "    // wtf??") "red"))
          (tt "5    goto $STACK.pop()"))))
))

(slide 
 (para #:align 'center (large-text "Example (TCO)"))
 (blank 50)
 (para #:align 'left
 (tt "def a = b(5)"))
 (blank 25)
