...
(define stack-for-exists (list   
  (tt "exists(p=_==5, list=[5])")
  (tt "exists(p=_==5, list=[4,5])")
  (tt "exists(p=_==5, list=[3,4,5])")
  (tt "exists(p=_==5, list=[2,3,4,5])")
  (tt "exists(p=_==5, list=[1,2,3,4,5])")))
...
(forward-call-stack "Stack Trace" stack-for-exists)
(rewind-call-stack "Stack Trace" stack-for-exists)
...
(slide (left-align (tt "exists(p=_==5, list=[1..1000000])")))
